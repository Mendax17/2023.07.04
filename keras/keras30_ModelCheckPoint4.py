...
save_path='c:/Users/eagle/Downloads/bitcamp/_save/MCP/'
...
print(save_name)
mcp=ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1, save_best_only=True, filepath=save_path+'k30_'+save_name)#filepath=path+'MCP/keras30_ModelCheckPoint3.hdf5')
