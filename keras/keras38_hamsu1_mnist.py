...
dense1=Conv2D(filters=128, kernel_size=2, activation='relu')(input1)
dense2=Conv2D(filters=64, kernel_size=2, activation='relu')(dense1)
dense3=Conv2D(filters=64, kernel_size=2, activation='relu')(dense2)
