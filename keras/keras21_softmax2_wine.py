...
#2. 모델구성
model=Sequential()
model.add(Dense(16, activation='linear', input_shape=(13,))) # 훈련되고 activation이 적용되는 원리
model.add(Dense(32, activation='linear')) # one hot encoding 을 거쳐 0, 1, 2 가 모두 0 또는 1 로 되었으므로 sigmoid 사용이 가능하다.
