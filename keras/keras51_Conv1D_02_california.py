...
#2. 모델구성
model=Sequential()
model.add(Conv1D(32, kernel_size=2, input_shape=(8, 1), activation='linear'))
...
mcp=ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1, save_best_only=True, filepath=save_mcp_path+'k51_Conv1D_02_california_'+save_name)
...
# mse :  0.43671953678131104
# mae :  0.47596728801727295
# R2 : 0.6647413003276516