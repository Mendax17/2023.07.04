...
#2. 모델구성
model=Sequential()
model.add(Conv2D(32, kernel_size=(2, 1), input_shape=(8, 1, 1), activation='linear'))
...
mcp=ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1, save_best_only=True, filepath=save_mcp_path+'k39_cnn02_california_'+save_name)
...
# mse :  0.4463244378566742
# mae :  0.46630293130874634
# R2 : 0.6573679295040571