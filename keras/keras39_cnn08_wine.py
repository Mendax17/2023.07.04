...
model.add(Conv2D(64, kernel_size=(2, 1), activation='linear'))
model.add(Dropout(0.1))
model.add(Conv2D(32, kernel_size=(2, 1), activation='linear'))
model.add(Dropout(0.1))
...
mcp=ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1, save_best_only=True, filepath=save_mcp_path+'k39_cnn08_wine_'+save_name)
...
# accuarcy_score : 0.9534883720930233