...
data_path='c:/Users/eagle/Downloads/bitcamp/AI/_data/human_horse/'
...
x_data=datagen.flow_from_directory(data_path, target_size=(200, 200), batch_size=1027, class_mode='categorical', color_mode='rgb', shuffle=True) # 폴더로 부터 데이터를 받아오는 함수

# print(x_data[0][0].shape) # (1027, 200, 200, 3)
# print(x_data[0][1].shape) # (1027, 2)
...
print(x_train.shape, y_train.shape) # (821, 200, 200, 3) (821, 2)
print(x_test.shape, y_test.shape) # (164, 200, 200, 3) (164, 2)
print(x_val.shape, y_val.shape) # (42, 200, 200, 3) (42, 2)
...
model.add(Dense(2, activation='softmax')) # y값이 ad폴더의 이미지인지 normal폴더의 이미지인지에 대한 데이터를 가지고 있기 때문에 0, 1만 가지고 있다. # 따라서 결과값을 sigmoid로 0 또는 1로 한정시켜준다.
...
# loss : 0.9455090761184692
# accuracy : 0.4652862250804901
# val_acc : 0.6428571343421936
# val_loss : 0.6925269365310669