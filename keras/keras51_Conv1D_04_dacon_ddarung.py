...
data_path='c:/Users/eagle/Downloads/bitcamp/AI/_data/ddarung/'
...
#2. 모델구성
model=Sequential()
model.add(Conv1D(32, kernel_size=2, input_shape=(9, 1), activation='linear'))
...
mcp=ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1, save_best_only=True, filepath=save_mcp_path+'k51_Conv1D_04_dacon_ddarung_'+save_name)
...
#random_state=300
# mse : 2179.955810546875
# mae : 37.22534942626953
# R2 : 0.6662715510155539
# RMSE : 46.68999749093822