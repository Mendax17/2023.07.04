...
#2. 모델구성
model=Sequential()
model.add(Conv2D(32, kernel_size=(2, 1), input_shape=(9, 1, 1), activation='linear'))
...
mcp=ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1, save_best_only=True, filepath=save_mcp_path+'k39_cnn04_dacon_ddarung_'+save_name)
...
#random_state=300
# mse : 2140.4580078125
# mae : 35.48755645751953
# R2 : 0.6723182275101987
# RMSE : 46.26508640908122