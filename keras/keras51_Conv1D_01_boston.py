...
x_test=x_test.reshape(121, 13, 1)
x_val=x_val.reshape(31, 13, 1)
...
mcp=ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1, save_best_only=True, filepath=save_mcp_path+'k51_Conv1D_01_boston_'+save_name)
...
# mse :  34.035240173339844
# mae :  3.759251832962036
# R2 : 0.6046647677101211