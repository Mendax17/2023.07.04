...
mcp=ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1, save_best_only=True, filepath=save_mcp_path+'k51_Conv1D_14_cifar100_'+save_name)#filepath=path+'MCP/keras34_ModelCheckPoint3.hdf5')
...
# loss : 6.979005336761475
# accuracy : 0.014624999836087227