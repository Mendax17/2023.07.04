...
x_val=x_val.reshape(-1, 64, 1, 1)

#2. 모델구성
model=Sequential()
model.add(Conv2D(32, kernel_size=(2, 1), input_shape=(64, 1, 1), activation='relu'))
...
mcp=ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1, save_best_only=True, filepath=save_mcp_path+'k39_cnn09_digits_'+save_name)
...
# accuarcy_score : 0.9791666666666666