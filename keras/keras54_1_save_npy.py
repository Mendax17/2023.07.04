...
xy_train=train_datagen.flow_from_directory(data_path+'train/', target_size=(200, 200), batch_size=10000, class_mode='binary', color_mode='grayscale', shuffle=True) # 폴더로 부터 데이터를 받아오는 함수
# categorical 을 하면 y값이 one-hot encoding 되서 나온다.
xy_test=train_datagen.flow_from_directory(data_path+'test/', target_size=(200, 200), batch_size=10000, class_mode='binary', color_mode='grayscale', shuffle=True)
