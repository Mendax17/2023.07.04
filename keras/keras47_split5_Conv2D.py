...
# 피쳐를 2로 바꿀거야
x_train=x_train.reshape(-1, 4, 1, 1) # (72, 2, 2)
x_test=x_test.reshape(-1, 4, 1, 1) # (24, 2, 2)
x_predict=x_predict.reshape(-1, 4, 1, 1) # (7, 2, 2)

print(x_train.shape, x_test.shape, x_predict.shape)

#2. 모델구성
model=Sequential()
model.add(Conv2D(32, kernel_size=(2, 1), input_shape=(4, 1, 1), activation='linear'))
