...
mcp=ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1, save_best_only=True, filepath=save_mcp_path+'k36_dnn4_cifar100_'+save_name)#filepath=path+'MCP/keras34_ModelCheckPoint3.hdf5')
