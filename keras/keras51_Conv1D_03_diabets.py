...
#2. 모델구성
model=Sequential()
model.add(Conv1D(32, kernel_size=2, input_shape=(10, 1), activation='linear'))
...
mcp=ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1, save_best_only=True, filepath=save_mcp_path+'k51_Conv1D_03_diabets_'+save_name)
...
# mse :  2811.96923828125
# mae :  44.40298843383789
# R2 : 0.5163962631501586